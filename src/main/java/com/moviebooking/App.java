...
//        List<String> commandLineArgs = new LinkedList<>(Arrays.asList("INPUT-FILE=./temp/input.txt","CINEMA-DATA=./temp/cinema.csv","SCREEN-DATA=./temp/screen.csv","SEAT-DATA=./temp/seat.csv","CUSTOMER-DATA=./temp/customer.csv","MOVIE-DATA=./temp/movie.csv","SHOW-DATA=./temp/show.csv"));
